...
export function FloatingWhatsApp() {
  ...
  return (
    ...
    >
      ...
      {tooltip && (
        <div
          className="bg-white rounded-2xl shadow-2xl border border-[rgba(0,0,0,0.06)] px-4 py-3 max-w-[200px] text-right"
          style={{
            animation: 'fade-in 0.2s ease-out',
          }}
        >
          <p className="text-[13px] font-semibold text-[#212529] font-heading">Need help? 👋</p>
          <p className="text-[11px] text-[#6C757D] mt-0.5 font-body">Chat with us on WhatsApp — real humans, 24/7</p>
        </div>
      )}

      {/* Button */}
      <a
        href="https://wa.me/923349542871?text=Hi%2C%20I%20need%20help%20with%20Axon%20eSIM"
        target="_blank"
