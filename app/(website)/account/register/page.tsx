...
import { userSignUp } from '@/app/actions/user-auth'
    ...
    <div className="min-h-screen bg-[#010206] flex flex-col items-center justify-center px-4 py-16">
      ...
      <div className="w-full max-w-sm">
        <div className="bg-white/[0.03] border border-white/[0.07] rounded-3xl p-8">
          ...
          <p className="text-sm text-slate-500 mb-7">Sign up to track your eSIM orders &amp; usage</p>
          ...
          <p className="mt-6 text-center text-sm text-slate-600">
            ...
            <Link href="/account/login" className="text-violet-400 hover:text-violet-300 font-semibold">
              Sign in
            </Link>
          </p>
        </div>
